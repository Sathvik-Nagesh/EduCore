    ...
    <div className="min-h-screen bg-white text-slate-900 p-6 md:p-20 relative overflow-hidden selection:bg-blue-100 selection:text-blue-900">
      ...
      <div className="max-w-3xl mx-auto card bg-white border border-slate-200 shadow-2xl p-8 md:p-12 relative z-10">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed font-medium">
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-xl mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-xl mb-3">2. User Accounts</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-xl mb-3">3. AI Usage Policy</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-xl mb-3">4. Attendance Accuracy</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-xl mb-3">5. Intellectual Property</h2>
