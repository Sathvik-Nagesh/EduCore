    ...
    <div className="min-h-screen bg-navy text-white p-6 md:p-20 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto card p-8 md:p-12">
        ...
        <div className="space-y-6 text-white/60 leading-relaxed">
          ...
          <section>
            <h2 className="text-white font-bold text-xl mb-3">2. How We Use Data</h2>
          ...
          <section>
            <h2 className="text-white font-bold text-xl mb-3">3. AI and Content</h2>
          ...
          <section>
            <h2 className="text-white font-bold text-xl mb-3">4. Cookies</h2>
